...
def generate_report_task(
    ...
    try:
        report_data = asyncio.get_event_loop().run_until_complete(_run())
    ...
    try:
        ...
        redis = asyncio.get_event_loop().run_until_complete(get_redis())
        asyncio.get_event_loop().run_until_complete(
            redis.set(cache_key, json.dumps(report_data, ensure_ascii=False), ex=REPORT_CACHE_TTL)
        )
